  ...
  return (
    <div className={cn("grid grid-cols-3 gap-2 w-48 h-48 p-3 rounded-lg bg-white/03", className)}>
      ...
      <Button 
        ...
        disabled={!onAux1}
        title={aux1Tooltip || aux1Action?.description || aux1Action?.displayName || 'Home'}
      >
        {aux1Action ? (
          <Icon 
      ...
      <Button 
        ...
        className="h-14 w-14 bg-transparent border border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-200"
        disabled={!onAux2}
        title={aux2Tooltip || aux2Action?.description || aux2Action?.displayName || 'Menu'}
      >
        {aux2Action ? (
          <Icon 
      ...
      <Button 
        ...
        className="h-14 w-14 bg-transparent border border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-200"
        disabled={!onLeft}
        title={leftTooltip || "Navigate Left"}
      >
      ...
      <Button 
        ...
        className="h-14 w-14 bg-transparent border border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-200"
        disabled={!onRight}
        title={rightTooltip || "Navigate Right"}
      >
      ...
      <Button 
        ...
        className="h-14 w-14 bg-transparent border border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-200"
        disabled={!onAux3}
        title={aux3Tooltip || aux3Action?.description || aux3Action?.displayName || 'Back'}
      >
        {aux3Action ? (
          <Icon 
      ...
      <Button 
        ...
        className="h-14 w-14 bg-transparent border border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-200"
        disabled={!onDown}
        title={downTooltip || "Navigate Down"}
      >
      ...
      <Button 
        ...
        className="h-14 w-14 bg-transparent border border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-200"
        disabled={!onAux4}
        title={aux4Tooltip || aux4Action?.description || aux4Action?.displayName || 'Exit'}
      >
        {aux4Action ? (
          <Icon 
